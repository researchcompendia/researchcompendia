...
env.get('DISQUS_API_KEY', 'none')
env.get('DISQUS_WEBSITE_SHORTNAME', 'researchcompendiaorg')
env.get('ADDTHIS_PUBID', 'ra-5334d4381d265227')
ADDTHIS_GA_TRACKING_ENABLED = True if env.get('ADDTHIS_GA_TRACKING_ENABLED', True) == 'True' else False
env.get('ADDTHIS_GA_TRACKER', 'UA-44934930-3')
env.get('GA_TRACKING_CODE', 'UA-44934930-3')
