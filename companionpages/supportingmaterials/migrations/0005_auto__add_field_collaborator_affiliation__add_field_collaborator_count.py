...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collaborator.affiliation'
        db.add_column(u'supportingmaterials_collaborator', 'affiliation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Collaborator.country'
        db.add_column(u'supportingmaterials_collaborator', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'Collaborator.name'
        db.alter_column(u'supportingmaterials_collaborator', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Collaborator.affiliation'
        db.delete_column(u'supportingmaterials_collaborator', 'affiliation')

        # Deleting field 'Collaborator.country'
        db.delete_column(u'supportingmaterials_collaborator', 'country')


        # Changing field 'Collaborator.name'
        db.alter_column(u'supportingmaterials_collaborator', 'name', self.gf('django.db.models.fields.TextField')(max_length=200))
