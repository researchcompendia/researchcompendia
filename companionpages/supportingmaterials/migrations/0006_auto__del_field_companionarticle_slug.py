...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CompanionArticle.slug'
        db.delete_column(u'supportingmaterials_companionarticle', 'slug')


    def backwards(self, orm):
        # Adding field 'CompanionArticle.slug'
        db.add_column(u'supportingmaterials_companionarticle', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2013, 9, 22, 0, 0), max_length=50, unique=True),
                      keep_default=False)
