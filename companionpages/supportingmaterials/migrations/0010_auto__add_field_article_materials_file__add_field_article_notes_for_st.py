...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.materials_file'
        db.add_column(u'supportingmaterials_article', 'materials_file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Article.notes_for_staff'
        db.add_column(u'supportingmaterials_article', 'notes_for_staff',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=5000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.materials_file'
        db.delete_column(u'supportingmaterials_article', 'materials_file')

        # Deleting field 'Article.notes_for_staff'
        db.delete_column(u'supportingmaterials_article', 'notes_for_staff')
