...
class Article(StatusModel, TimeStampedModel):
    ...
    authorship = jsonfield.JSONField(verbose_name=_(u'Authors'), load_kwargs={'object_pairs_hook': collections.OrderedDict}, help_text=_(u'Loosely structured info for authorship for authors who do not have site accounts'), default="{}")
