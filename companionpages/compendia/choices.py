...
ENTRY_TYPES = Choices(
    ('article', _(u'Journal or Magazine Articles')),
    ('book', _(u'Books')),
    ('booklet', _(u'Booklets')),
    ('inbook', _(u'Book Chapters or Sections')),
    ('incollection', _(u'Book collections')),
    ('inproceedings', _(u'Conference Proceedings Articles')),
    ('manual', _(u'Technical Documentation')),
    ('mastersthesis', _(u'Master’s Theses')),
    ('misc', _(u'Miscellanea')),
    ('phdthesis', _(u'PhD Theses')),
    ('proceedings', _(u'Conference Proceedings')),
    ('techreport', _(u'Technical Reports')),
    ('unpublished', _(u'Unpublished Documents')),
    # non-bibtex classifications
    ('published_paper', _(u'Published Papers')),
    ('working_paper', _(u'Working Papers')),
    ('misc_methods_paper', _(u'Methods Papers')),
    ('misc_negative_results', _(u'Negative Results')),
    ('misc_public_tool', _(u'Public Tools')),
    ('misc_course', _(u'Course Materials')),
    ('misc_dataset', _(u'Datasets')),
