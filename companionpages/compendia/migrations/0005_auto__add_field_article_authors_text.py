...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.authors_text'
        db.add_column(u'compendia_article', 'authors_text',
                      self.gf('django.db.models.fields.TextField')(default='authors', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.authors_text'
        db.delete_column(u'compendia_article', 'authors_text')
