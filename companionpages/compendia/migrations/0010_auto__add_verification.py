...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'compendia_verification', (
            ...
            ('status', self.gf('model_utils.fields.StatusField')(default='unknown', max_length=100, no_check_for_status=True)),
            ...
            ('stdin', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('requestid', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('parameters', self.gf('jsonfield.fields.JSONField')(default='{}')),
            ('archive_info', self.gf('jsonfield.fields.JSONField')(default='{}')),
            ('archive_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('article',), max_length=50, populate_from='populate_slug')),
        ))
        db.send_create_signal(u'compendia', ['Verification'])


    def backwards(self, orm):
        # Deleting model 'Verification'
        db.delete_table(u'compendia_verification')
    ...
    models = {
        ...
        u'compendia.verification': {
            ...
            'status_changed': ('model_utils.fields.MonitorField', [], {'default': 'datetime.datetime.now', u'monitor': "u'status'"}),
            'stdin': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
