...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.lecture_notes_archive_file'
        db.add_column(u'compendia_article', 'lecture_notes_archive_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.homework_archive_file'
        db.add_column(u'compendia_article', 'homework_archive_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.solution_archive_file'
        db.add_column(u'compendia_article', 'solution_archive_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.lecture_notes_archive_file'
        db.delete_column(u'compendia_article', 'lecture_notes_archive_file')

        # Deleting field 'Article.homework_archive_file'
        db.delete_column(u'compendia_article', 'homework_archive_file')

        # Deleting field 'Article.solution_archive_file'
        db.delete_column(u'compendia_article', 'solution_archive_file')
