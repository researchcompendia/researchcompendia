...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Verification.stdin'
        db.delete_column(u'compendia_verification', 'stdin')

        # Adding field 'Verification.stderr'
        db.add_column(u'compendia_verification', 'stderr',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Article.admin_notes'
        db.add_column(u'compendia_article', 'admin_notes',
                      self.gf('markitup.fields.MarkupField')(default='', max_length=5000, no_rendered_field=True, blank=True),
                      keep_default=False)

        # Adding field 'Article._admin_notes_rendered'
        db.add_column(u'compendia_article', '_admin_notes_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Verification.stdin'
        db.add_column(u'compendia_verification', 'stdin',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Verification.stderr'
        db.delete_column(u'compendia_verification', 'stderr')

        # Deleting field 'Article.admin_notes'
        db.delete_column(u'compendia_article', 'admin_notes')

        # Deleting field 'Article._admin_notes_rendered'
        db.delete_column(u'compendia_article', '_admin_notes_rendered')
