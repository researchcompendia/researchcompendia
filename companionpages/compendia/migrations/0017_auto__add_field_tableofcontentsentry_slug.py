...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TableOfContentsEntry.slug'
        db.add_column(u'compendia_tableofcontentsentry', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='abc', unique_with=(), max_length=50, populate_from='entry_text'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TableOfContentsEntry.slug'
        db.delete_column(u'compendia_tableofcontentsentry', 'slug')
    ...
    models = {
        ...
        u'compendia.tableofcontentsentry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'populate_from': "'entry_text'"})
        },
