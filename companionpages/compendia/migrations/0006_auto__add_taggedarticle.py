...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'compendia_taggedarticle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'compendia_taggedarticle_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['compendia.Article'])),
            ('tag_type', self.gf('django.db.models.fields.CharField')(default='folksonomic', max_length=50, blank=True)),
        ))
        db.send_create_signal(u'compendia', ['TaggedArticle'])


    def backwards(self, orm):
        # Deleting model 'TaggedArticle'
        db.delete_table(u'compendia_taggedarticle')
