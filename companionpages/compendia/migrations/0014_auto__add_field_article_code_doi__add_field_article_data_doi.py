...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.code_doi'
        db.add_column(u'compendia_article', 'code_doi',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000, blank=True),
                      keep_default=False)

        # Adding field 'Article.data_doi'
        db.add_column(u'compendia_article', 'data_doi',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.code_doi'
        db.delete_column(u'compendia_article', 'code_doi')

        # Deleting field 'Article.data_doi'
        db.delete_column(u'compendia_article', 'data_doi')
