...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.verification_archive_file'
        db.add_column(u'compendia_article', 'verification_archive_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.verification_archive_file'
        db.delete_column(u'compendia_article', 'verification_archive_file')
