...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.description_header'
        db.add_column(u'compendia_article', 'description_header',
                      self.gf('django.db.models.fields.CharField')(default='Code and Data Abstract', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.description_header'
        db.delete_column(u'compendia_article', 'description_header')
    ...
    models = {
        ...
        u'compendia.article': {
            ...
            'description_header': ('django.db.models.fields.CharField', [], {'default': "'Code and Data Abstract'", 'max_length': '100'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_archive_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'compendia.tableofcontentsentry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'entry_text'", 'unique_with': '()'})
        },
