...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.content_license'
        db.add_column(u'compendia_article', 'content_license',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Article.code_license'
        db.add_column(u'compendia_article', 'code_license',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.content_license'
        db.delete_column(u'compendia_article', 'content_license')

        # Deleting field 'Article.code_license'
        db.delete_column(u'compendia_article', 'code_license')
