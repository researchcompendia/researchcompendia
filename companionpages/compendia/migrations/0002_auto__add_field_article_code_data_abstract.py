...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.code_data_abstract'
        db.add_column(u'compendia_article', 'code_data_abstract',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=5000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.code_data_abstract'
        db.delete_column(u'compendia_article', 'code_data_abstract')
