...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'compendia_article', (
            ...
            ('authorship', self.gf('json_field.fields.JSONField')(default=u'null', blank=True)),
            ('doi', self.gf('django.db.models.fields.CharField')(max_length=2000, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('paper_abstract', self.gf('django.db.models.fields.TextField')(max_length=5000, blank=True)),
            ...
            ('related_urls', self.gf('json_field.fields.JSONField')(default=u'null', blank=True)),
            ...
            ('code_archive_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('data_archive_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
