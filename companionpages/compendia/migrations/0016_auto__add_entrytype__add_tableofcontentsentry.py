...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'compendia_entrytype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('compendium_type', self.gf('django.db.models.fields.CharField')(default='misc', unique=True, max_length=100)),
            ('table_of_content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['compendia.TableOfContentsEntry'])),
        ))
        db.send_create_signal(u'compendia', ['EntryType'])

        # Adding model 'TableOfContentsEntry'
        db.create_table(u'compendia_tableofcontentsentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry_text', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('entry_order', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=500, blank=True)),
        ))
        db.send_create_signal(u'compendia', ['TableOfContentsEntry'])


    def backwards(self, orm):
        # Deleting model 'EntryType'
        db.delete_table(u'compendia_entrytype')

        # Deleting model 'TableOfContentsEntry'
        db.delete_table(u'compendia_tableofcontentsentry')
    ...
    models = {
        ...
        u'compendia.entrytype': {
            'Meta': {'object_name': 'EntryType'},
            'compendium_type': ('django.db.models.fields.CharField', [], {'default': "'misc'", 'unique': 'True', 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'table_of_content': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['compendia.TableOfContentsEntry']"})
        },
        u'compendia.tableofcontentsentry': {
            'Meta': {'ordering': "['entry_order']", 'object_name': 'TableOfContentsEntry'},
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'blank': 'True'}),
            'entry_order': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'entry_text': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
