...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_user', 'affiliation',
    ...
    def backwards(self, orm):
        # Deleting field 'User.public_name'
        db.delete_column(u'users_user', 'public_name')

        # Deleting field 'User.biography'
        db.delete_column(u'users_user', 'biography')

        # Deleting field 'User.affiliation'
        db.delete_column(u'users_user', 'affiliation')
